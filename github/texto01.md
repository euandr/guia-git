...
3. Fluxo de Trabalho em Equipe (GitHub Flow)
...
### 🔑 Criação de Conta e Interface Web
...
### 🛡️ Autenticação Segura (Personal Access Tokens ou SSH)
...
💡 Dica de Ouro: Sempre dê git pull no início do seu expediente de trabalho para evitar trabalhar em uma versão desatualizada do código!
...
[main] -------------------------------------------------> [main atualizada]
          \                                         /
           \-- [feature-branch] --> [Pull Request] --/

### 🔀 1. Trabalhando em Branches
...
## 📌 Checklist Rápido para Entregas de Trabalhos
[ ] Todo o grupo tem acesso ao repositório?
[ ] O arquivo README.md explica do que se trata o projeto e como executá-lo?
[ ] Todas as branches secundárias foram unificadas na main via Pull Request?
[ ] O quadro do GitHub Projects reflete todas as tarefas concluídas?